...
module.exports = NodeHelper.create({
    ...
    socketNotificationReceived: function(notification, payload) {
        switch (notification) {
            ...
            case "HA_POST_STATE":
                ...
                break;
            case "HA_EXECUTE_SCRIPT":
                this.executeScript(payload);
                break;
            default:
                break;
        }
    ...
    executeScript: function(payload) {
        var url = payload.baseUrl + "/api/services/script/turn_on";
        var requestData = {"entity_id": payload.entityId};
        ...
        request({
            ...
            if (!error && response.statusCode == 200) {
                this.sendSocketNotification('HA_EXECUTE_SCRIPT_RET');
            }
        });
    },
});
